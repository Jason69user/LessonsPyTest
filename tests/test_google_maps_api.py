...
class TestCreatePlace:
    ...
    def test_create_new_place(self):
        ...
        Checking.check_search_word_in_value(result_put, 'msg', 'successfully')
        ...
        Checking.check_search_word_in_value(result_get, 'address', 'Sangvinius')
        ...
        Checking.check_search_word_in_value(result_get, 'msg', 'failed')
